...
if dataID == 1
    ...
    resultDir = 'D:\UCSD_Acads\ProfGal_Research\test_run_norm1_pca0_kNN16_sftune4_hemisphere_1_AllenOrdered';
end
if dataID == 2
    dataDir = 'D:\UCSD_Acads\ProfGal_Research\data_fMRI_GSR_processed\GSR_1voxelmask_new';
    resultDir = 'D:\UCSD_Acads\ProfGal_Research\data_fMRI_GSR_processed\GSR_1voxelmask_results\test_run_norm1_pca0_kNN16_sftune4_hem_AllenOrdered';
end
if dataID == 3
    dataDir = 'D:\UCSD_Acads\ProfGal_Research\data_fMRI_GSR_processed\GSR_thickermask_new';
    resultDir = 'D:\UCSD_Acads\ProfGal_Research\data_fMRI_GSR_processed\GSR_thickermask_results\test_run_norm1_pca0_kNN16_sftune4_hem_AllenOrdered';
end
if dataID == 4
        ...
        for i = 1:length(fileList) % processing each .nii file
            ...
            if ((i == 1 || strcmp(prev_sub, sub_value)) && i ~= length(fileList))    % runs belong to same subject
                ...
                for hemisp = 1:2
                    ...
                    cfg.title_str = ['sub_' prev_sub '_session_' num2str(prev_ses) '_hemisp_' num2str(hemisp)];
