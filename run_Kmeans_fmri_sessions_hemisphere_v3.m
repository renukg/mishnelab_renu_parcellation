...
if dataID == 1
    ...
    resultDir = 'D:\UCSD_Acads\ProfGal_Research\test_run_KNN27_hemisphere_replicas100_v3_minclstPix_15_new_AllenOrdered';
end
if dataID == 2
    dataDir = 'D:\UCSD_Acads\ProfGal_Research\data_fMRI_GSR_processed\GSR_1voxelmask_new';
    resultDir = 'D:\UCSD_Acads\ProfGal_Research\data_fMRI_GSR_processed\GSR_1voxelmask_results\test_run_KNN27_hem_replicas100_minclstPix_15_AllenOrdered';
end
if dataID == 3
    dataDir = 'D:\UCSD_Acads\ProfGal_Research\data_fMRI_GSR_processed\GSR_thickermask_new';
    resultDir = 'D:\UCSD_Acads\ProfGal_Research\data_fMRI_GSR_processed\GSR_thickermask_results\test_run_KNN27_hem_replicas100_minclstPix_15_AllenOrdered';
end
if dataID == 4
        ...
        for i = 1:length(fileList) % processing each .nii file
            ...
            if ((i == 1 || strcmp(prev_sub, sub_value)) && i ~= length(fileList))    % runs belong to same subject
                ...
                for hemisp = 1:2
                    ...
                    % figure;
                    % imagesc(label2rgb(labels_before));
                    % figure;
